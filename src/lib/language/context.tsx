...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // AI Writer Landing Section
    "aiwriter.badge": "Powered by Mr. Job",
    "aiwriter.title": "Stop Writing.\nLet Mr. Job Generate Your Applications.",
    "aiwriter.subtitle": "Feed Mr. Job your target job and it will autonomously research the company and generate highly-converting application copy tailored to your skills.",
    "aiwriter.feature.1.title": "1-Click Cover Letters",
    "aiwriter.feature.1.description": "Instantly generate a tailored 250-300 word cover letter. No more staring at a blank page, just click and review.",
    "aiwriter.feature.2.title": "Automated Multi-Channel Outreach",
    "aiwriter.feature.2.description": "Automatically format messages for Email, LinkedIn DMs, WhatsApp, or Instagram. Just copy, paste, and send.",
    "aiwriter.feature.3.title": "Deep Company Scraping",
    "aiwriter.feature.3.description": "Mr. Job autonomously scans the company's website to align your message with their core mission and culture.",
    "aiwriter.feature.4.title": "Pay-Per-Generation",
    "aiwriter.feature.4.description": "Only 80 JPs per generation. Use your free weekly allocation, or top-up instantly when you need more.",
    "aiwriter.cta": "Generate Your First Draft",
    "aiwriter.mockup.cover_letter_tab": "Cover Letter",
    "aiwriter.mockup.outreach_tab": "LinkedIn DM",
    "aiwriter.mockup.generating": "Mr. Job is generating...",
    "aiwriter.mockup.cover_letter.p1": "I am writing to express my strong interest in the Full Stack Developer position at sopan.id. Based on my experience building Next.js applications and implementing complex UI/UX features, I am confident in my ability to contribute effectively to your team.",
    "aiwriter.mockup.cover_letter.p2": "In my previous project, JobTracker, I engineered a highly responsive...",
    "aiwriter.mockup.outreach.p1": "Hi [Recruiter Name],",
    "aiwriter.mockup.outreach.p2": "I noticed sopan.id is expanding its engineering team. I'm a Full Stack Developer with a strong background in Next.js and TypeScript. I recently built a comprehensive job tracking platform with a custom credit system and AI integrations.",
    "aiwriter.mockup.outreach.p3": "I'd love to connect and learn more about the challenges your team is currently tackling!",
    ...
    "faq.a7": "No. All purchases are final including subscriptions, lifetime access, and JPs top-ups. If you have concerns about your purchase, feel free to reach out to us.",
    ...
    "pricing.free.feature2": "Basic Application Tracker",
    ...
    "pricing.monthly.feature2": "Application Tracker & Smart Filters",
    ...
    "pricing.guarantee": "All purchases are final",
    ...
    // Job Search
    "job_search.title": "Job Search",
    "job_search.subtitle": "Find jobs across LinkedIn, Indeed, Glassdoor & more",
    "job_search.tab.search": "Search",
    "job_search.tab.saved": "Saved",
    "job_search.placeholder.keyword": "Job title, keyword, or company",
    "job_search.placeholder.location": "City, state, or country",
    "job_search.sources": "Sources",
    "job_search.filters": "Filters",
    "job_search.job_type": "Job Type",
    "job_search.posted_within": "Posted within",
    "job_search.remote": "Remote only",
    "job_search.results_wanted": "Results",
    "job_search.country": "Country (Indeed)",
    "job_search.button.search": "Search Jobs",
    "job_search.empty.title": "Search for jobs",
    "job_search.empty.subtitle": "Enter a keyword to find opportunities across multiple job boards",
    "job_search.found": "Found",
    "job_search.no_results": "No jobs found",
    "job_search.no_results.subtitle": "Try different keywords, locations, or adjust your filters",
    "job_search.save": "Save",
    "job_search.saved": "Saved",
    "job_search.import": "Import to Tracker",
    "job_search.importing": "Importing...",
    "job_search.open": "Open",
    "job_search.saved_empty.title": "No saved jobs yet",
    "job_search.saved_empty.subtitle": "Search for jobs and bookmark the ones you like",
    "job_search.jobs": "jobs",
    "job_search.job": "job",
  ...
  id: {
    ...
    // AI Writer Landing Section
    "aiwriter.badge": "Powered by Mr. Job",
    "aiwriter.title": "Gak Perlu Nulis Lagi.\nBiar AI yang Bikin Lamaranmu.",
    "aiwriter.subtitle": "Mr. Job otomatis membedah profilmu, ngescrape website perusahaan lamaran dan generate teks lamaran yang super personal dalam hitungan detik.",
    "aiwriter.feature.1.title": "Auto-Generate Cover Letter",
    "aiwriter.feature.1.description": "Hasilkan cover letter 250-300 kata secara instan. Tinggal klik, otomatis jadi. Bebas pusing merangkai kata.",
    "aiwriter.feature.2.title": "Otomatisasi Multi-Channel",
    "aiwriter.feature.2.description": "Generate format pesan outreach untuk Email, LinkedIn DM, WhatsApp, sampai IG DM. Tinggal copy-paste dan kirim.",
    "aiwriter.feature.3.title": "Auto-Scrape Target Perusahaan",
    "aiwriter.feature.3.description": "Sistem otomatis membaca visi-misi dari website perusahaan buat nyamain tone bahasa lamaranmu dengan kultur mereka.",
    "aiwriter.feature.4.title": "Sistem Pay-as-You-Go",
    "aiwriter.feature.4.description": "Cuma 80 JPs per generate. Dapatkan JP gratis tiap minggu, atau top-up instan kalau lagi butuh banyak.",
    "aiwriter.cta": "Coba Generate Sekarang",
    "aiwriter.mockup.cover_letter_tab": "Cover Letter",
    "aiwriter.mockup.outreach_tab": "LinkedIn DM",
    "aiwriter.mockup.generating": "Mr. Job sedang menulis...",
    "aiwriter.mockup.cover_letter.p1": "Saya ingin menyampaikan ketertarikan saya pada posisi Full Stack Developer di sopan.id. Berdasarkan pengalaman saya membangun aplikasi Next.js dan mengimplementasikan fitur UI/UX kompleks, saya yakin dapat berkontribusi efektif untuk tim Anda.",
    "aiwriter.mockup.cover_letter.p2": "Di proyek sebelumnya, JobTracker, saya membangun platform yang sangat responsif...",
    "aiwriter.mockup.outreach.p1": "Halo [Nama Recruiter],",
    "aiwriter.mockup.outreach.p2": "Saya melihat sopan.id sedang memperluas tim engineering. Saya seorang Full Stack Developer dengan pengalaman kuat di Next.js dan TypeScript. Saya baru saja membangun platform job tracking lengkap dengan sistem kredit custom dan integrasi AI.",
    "aiwriter.mockup.outreach.p3": "Saya ingin terhubung dan belajar lebih lanjut tentang tantangan yang sedang tim Anda hadapi!",
    ...
    "faq.a7": "Tidak. Semua pembelian bersifat final termasuk langganan, akses seumur hidup, dan top-up JPs. Jika kamu memiliki keluhan terkait pembelian, silakan hubungi kami.",
    ...
    "pricing.free.feature2": "Pelacak Lamaran Dasar",
    ...
    "pricing.monthly.feature2": "Pelacak Lamaran & Filter Pintar",
    ...
    "pricing.guarantee": "Semua pembelian bersifat final",
    ...
    "sidebar.job_search": "Cari Lowongan",
    ...
    // Job Search
    "job_search.title": "Cari Lowongan",
    "job_search.subtitle": "Temukan lowongan dari LinkedIn, Indeed, Glassdoor & lainnya",
    "job_search.tab.search": "Cari",
    "job_search.tab.saved": "Tersimpan",
    "job_search.placeholder.keyword": "Judul pekerjaan, kata kunci, atau perusahaan",
    "job_search.placeholder.location": "Kota, provinsi, atau negara",
    "job_search.sources": "Sumber",
    "job_search.filters": "Filter",
    "job_search.job_type": "Tipe Pekerjaan",
    "job_search.posted_within": "Diposting dalam",
    "job_search.remote": "Hanya remote",
    "job_search.results_wanted": "Hasil",
    "job_search.country": "Negara (Indeed)",
    "job_search.button.search": "Cari Lowongan",
    "job_search.empty.title": "Cari lowongan kerja",
    "job_search.empty.subtitle": "Masukkan kata kunci untuk menemukan peluang dari berbagai platform",
    "job_search.found": "Ditemukan",
    "job_search.no_results": "Tidak ada lowongan ditemukan",
    "job_search.no_results.subtitle": "Coba kata kunci berbeda, lokasi lain, atau ubah filter",
    "job_search.save": "Simpan",
    "job_search.saved": "Tersimpan",
    "job_search.import": "Impor ke Tracker",
    "job_search.importing": "Mengimpor...",
    "job_search.open": "Buka",
    "job_search.saved_empty.title": "Belum ada lowongan tersimpan",
    "job_search.saved_empty.subtitle": "Cari lowongan dan simpan yang kamu suka",
    "job_search.jobs": "lowongan",
    "job_search.job": "lowongan",
