...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "aiwriter.title": "Resumes and outreach messages that write themselves.",
    "aiwriter.subtitle": "JobTracker AI Writer menganalisis profile-mu, melakukan scraping ke website target, dan membuat application content yang highly-personalized.",
    "aiwriter.feature.1.title": "Cover Letters on Autopilot",
    "aiwriter.feature.1.description": "Hasilkan cover letter 250-300 kata yang terpersonalisasi dalam hitungan detik. Bebas writer's block.",
    "aiwriter.feature.2.title": "Multi-Channel Outreach",
    "aiwriter.feature.2.description": "Format otomatis untuk Email, LinkedIn DM, WhatsApp, atau Instagram DM. Tinggal copy & send.",
    "aiwriter.feature.3.title": "Smart Company Scraping",
    "aiwriter.feature.3.description": "AI membaca website perusahaan untuk menyesuaikan tone dengan misi dan kultur mereka.",
    "aiwriter.feature.4.title": "Pay as You Go",
    "aiwriter.feature.4.description": "Hanya 80 JPs per generasi. Dapat alokasi JPs mingguan gratis, atau top-up jika kurang.",
    "aiwriter.cta": "Try AI Writer Free",
  ...
  id: {
    ...
    // AI Writer Landing Section
    "aiwriter.badge": "Ditenagai Mr. Job",
    "aiwriter.title": "Resume dan pesan outreach yang menulis sendiri.",
    "aiwriter.subtitle": "JobTracker AI Writer menganalisis profilmu, melakukan scraping ke website target, dan membuat application content yang highly-personalized.",
    "aiwriter.feature.1.title": "Cover Letter Otomatis",
    "aiwriter.feature.1.description": "Hasilkan cover letter 250-300 kata yang terpersonalisasi dalam hitungan detik. Bebas writer's block.",
    "aiwriter.feature.2.title": "Multi-Channel Outreach",
    "aiwriter.feature.2.description": "Format otomatis untuk Email, LinkedIn DM, WhatsApp, atau Instagram DM. Tinggal copy & send.",
    "aiwriter.feature.3.title": "Smart Company Scraping",
    "aiwriter.feature.3.description": "AI membaca website perusahaan untuk menyesuaikan tone dengan misi dan kultur mereka.",
    "aiwriter.feature.4.title": "Bayar Sesuai Penggunaan",
    "aiwriter.feature.4.description": "Hanya 80 JPs per generasi. Dapat alokasi JPs mingguan gratis, atau top-up jika kurang.",
    "aiwriter.cta": "Coba AI Writer Gratis",
    "aiwriter.mockup.cover_letter_tab": "Cover Letter",
    "aiwriter.mockup.outreach_tab": "LinkedIn DM",
