      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-card border border-border rounded-2xl shadow-lg p-8 md:p-10 text-center relative overflow-hidden group">  
            ...
            <button 
                onClick={handleLogin}
                disabled={isLoading}
                className={`w-full flex items-center justify-center gap-3 bg-white text-slate-900 dark:bg-slate-900 dark:text-white border border-border px-6 py-4 rounded-lg font-semibold tracking-wide transition-all duration-300 shadow-md ${
                  isLoading ? "opacity-70 cursor-wait" : "hover:bg-gray-50 dark:hover:bg-slate-800 hover:scale-[1.02] active:scale-[0.98]"
                }`}
            >
                {isLoading ? (
