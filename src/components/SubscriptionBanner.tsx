...
export function SubscriptionBanner() {
  ...
  const monthlyOptions = {
    ...
    vault: true,
    currency: "USD",
    "data-namespace": "paypal_subscriber", // PENTING: Namespace unik
    ...(PAYPAL_ENV.isSandbox && {
      "buyer-country": "US", // Seringkali wajib di sandbox subscription
      "data-environment": "sandbox",
    }),
  };
  const lifetimeOptions = {
    clientId: PAYPAL_CREDENTIALS.clientId,
    intent: "capture", // Default untuk one-time payment
    currency: "USD",
    "data-namespace": "paypal_lifetime", // PENTING: Namespace unik
    ...(PAYPAL_ENV.isSandbox && {
      "buyer-country": "US",
      "data-environment": "sandbox",
    }),
