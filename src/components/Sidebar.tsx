...
import { BarChart3, Briefcase, User, X, Settings, BriefcaseBusiness, Users, Sparkles, Contact } from "lucide-react";
...
export type SidebarSection = "dashboard" | "applications" | "freelance" | "clients" | "ai-writer" | "contact-finder" | "profile" | "settings";
...
export default function Sidebar({ activeSection, onSectionChange, isMobileOpen, onMobileClose, trackerMode, onTrackerModeChange, jobCount = 0, clientCount = 0 }: SidebarProps) {
  ...
  const jobNavItems: Array<{
    ...
    { id: "contact-finder", label: "Contact Finder", icon: Contact },
