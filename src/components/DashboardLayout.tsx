...
export default function DashboardLayout({ jobs, userId, plan }: DashboardLayoutProps) {
  ...
  return (
    <div className={`flex ${activeSection === "applications" ? "h-[calc(100vh-80px)]" : "min-h-screen"} pt-16 lg:pt-20 overflow-hidden`}>
      ...
      <main className={`flex-1 lg:pl-64 w-full ${activeSection === "applications" ? "overflow-hidden" : ""}`}>
        <div className={`${activeSection === "applications" ? "h-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-18" : "max-w-7xl mx-auto p-4 md:p-6 pb-24 lg:pb-12"}`}>
          {/* Section Header */}
