...
// --- Fungsi Pembantu (Sama dengan di BillingPage) ---
...
export function SubscriptionInfo() {
  ...
  // Mengambil data mentah sesuai status (seperti logika di Billing)
  const dateToShow = isActive ? subscription.renewsAt : subscription.endsAt;
  const displayDate = formatDate(dateToShow);
