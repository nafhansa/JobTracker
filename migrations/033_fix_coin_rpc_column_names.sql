-- ===========================================
-- 033: Fix get_or_create_coins_atomic column names
-- RPC returns out_* prefixed columns but TS code expects unprefixed names
-- This caused NaN JPs because undefined + undefined = NaN
-- ===========================================
